...
def botw():
    return render_template(
            "gameinfo.html", image = "IMG/botw.png", 
...
def celeste():
    return render_template(
            "gameinfo.html", image = "IMG/celeste.png", 
...
def dbsz():
    return render_template(
            "gameinfo.html", image = "IMG/dbsz.png", 
...
def deadcells():
    return render_template(
            "gameinfo.html", image = "IMG/deadcells.png", 
...
def eldinring():
    return render_template(
            "gameinfo.html", image = "IMG/eldinring.png", 
...
def got():
    return render_template(
            "gameinfo.html", image = "IMG/got.png", 
...
def hollowknight():
    return render_template(
            "gameinfo.html", image = "IMG/hollowknight.png", 
...
def pokemon_bw():
    return render_template(
            "gameinfo.html", image = "IMG/bw.png", 
...
def sa2():
    return render_template(
            "gameinfo.html", image = "IMG/sa2.png", 
